...
function withdrawMTPItem (uint256 tokenId) {
    //require token is mtp item
    //require msg.sender is tokenOwner
    //require tokenOwner bibo balance >= 0
    //settle bibo accounts: burn all bibos in all accounts generated by transfers of this token
